const allProjects = [
    {
        ...
        contract: "Виконання будівельно-монтажних та пусконалагоджувальних робіт на пристанційному вузлі ПС 110 кВ Сонячна-Арциз",
    ...
    },
    {
        ...
        client: "ДП НЕК «Укренерго»",
        contract: "Будівельно-монтажні та пусконалагоджувальні роботи на ПЛ 110 кВ СЕС «Сонячна-Кілія» та на пристанційному вузлі ПС 110 кВ Сонячна-Кілія",
    ...
    },
    {
        ...
        client: "ДП НЕК «Укренерго»",
        contract: "Виконання будівельно-монтажних та пусконалагоджувальних робіт з постачання обладнання на ПС 330 кВ «Усатове»",
    ...
    },
    {
        ...
        client: "ДП НЕК «Укренерго»",
        contract: "Роботи з заміни двох масляних вимикачів 110 кВ типу ВМТ-110 на приєднаннях «Більшовик», «Лузанівка» на елегазові вимикачі, заміною трансформаторів току ТС – 110 на ПС 220 кВ «Центроліт» з виконанням будівельно – монтажних, пусконалагоджувальних робіт.",
        sector: "Електроенергетика",
        region: "Україна, Одеська область",
        period: "2012"
    },
    {
        image: "../../images/projects_images/Rekonstruktsiya_PL_330kV_Kryvorizka_TES_Trykhati/PL_330kV_Kryvorizka_TES_Trykhaty.JPG",
    ...
    },
    {
            ...
            title:
                "РЕКОНСТРУКЦІЯ ПС 750 КВ «ВІННИЦЬКА»",
        ...
        },
        {
            ...
            contract:
                "Реконструкція ПЛ 110 кВ «АДЖАЛИК-БЕРЕГОВА 1,2».",
            sector: "Електроенергетика",
            region: "Українa, Одеська обл.",
            period: "2018",
        },
        {
            ...
            client: "ДП «НЕК «Укренерго»",
            contract:
                "Будівництво ПЛ 750 кВ «Рівненська АЕС – ПС Київська».",
            sector: "Електроенергетика",
        ...
        },
        {
            ...
            contract: "Проектні, будівельно-монтажні, пусконалагоджувальні роботи, постачання, монтаж та введення в експлуатацію нових насосних станцій",
        ...
        },
        {
            ...
            title:
                "БУДІВНИЦТВО ПС 750/330 кВ «КАХОВСЬКА»",
            client: "ПрАТ «НЕК «Укренерго»",
            contract: " Будівництво ПС 750/330 кВ «Каховська», постачання та монтаж АТ 2 1000 МВА, автоматизованої системи управління технологічними процесами, системи релейного захисту та автоматики, а також спорудження спорідненої інфраструктури.",
            sector: "Електроенергетика",
        ...
        },
        {
            ...
            title:
                "ПЛ 110 кВ СЕС «СОНЯЧНА - АРЦИЗ», ПС 110 кВ СОНЯЧНА-АРЦИЗ",
            client: "ДП НЕК «Укренерго»",
            contract: "Виконання будівельно-монтажних та пусконалагоджувальних   робіт на пристанційному вузлі ПС 110 кВ Сонячна-Арциз",
            sector: "Альтернативна енергетика",
            region: "Україна, Одеська область",
        ...
        },
        {
            ...
            client: "ДП НЕК «Укренерго»",
            contract:
                "Роботи з реконструкції ПЛ 220 кВ в прогоні опор 1-99",
            sector: "Електроенергетика",
            region: "Україна, Івано-Франківська обл.",
            period: "2013",
        },
        ...
        {
            image:
                "../../images/projects_images/Rekonstruktsiya_PL_330kV_Moldavska_DRES_Kotovska/Opora_typu_PB-330-7n.JPG",
            link: "../../pages/projects/project_page_example.html?id=25",
            title:
                "РЕКОНСТРУКЦІЯ ПЛ 330 кВ МОЛДАВСЬКА ДРЕС-КОТОВСЬКА",
            client: "ДП НЕК «Укренерго»",
        ...
        },
        {
            ...
            contract:
                "Реконструкція ПЛ 110 кВ Кіровська – Більшовик, Усатове – Кіровська, Усатове –Центроліт",
            sector: "Електроенергетика",
            region: "Українa",
            period: "2010-2011",
        },
        {
            ...
            client: "ДП НЕК «Укренерго»",
            contract:
                "Роботи з заміни чотирьох повітряних вимикачів 330 кВ на елегазові вимикачі",
            sector: "Електроенергетика",
        ...
        },
        {
            ...
            title:
                "ДЕМОНТАЖ ПЛ 330 кВ АДЖАЛИК - УСАТОВЕ",
            client: "ДП НЕК «Укренерго»",
        ...
        },
        {
            ...
            contract:
                "Будівництво Орлівської вітрової електростанції",
            sector: "Альтернативна енергетика",
        ...
        },
        {
        ...
        },
         {
            ...
            title:
                "ПОСТАЧАННЯ РОЗ’ЄДНУВАЧІВ НА НАПРУГУ 750 кВ ДЛЯ ПІДКЛЮЧЕННЯ ПЛ 750 кВ «ЗАПОРІЗЬКА АЕС-КАХОВСЬКА»",
            client: "ДП НЕК «Укренерго»",
        ...
        },
        {
            ...
            title:
                "Реконструкція повітряної лінії 110 кВ «Старокозаче – Канал",
...
document.addEventListener('DOMContentLoaded', () => {
    const isBigProjectsPage = window.location.pathname.includes('big_projects.html');
    filteredProjects = isBigProjectsPage
