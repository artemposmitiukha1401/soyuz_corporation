const allProjects = [
    ...
    },
    {
        ...
        contract: " Технічне переоснащення ПС 330 кВ «Новокиївська». Проєктування, виробництво, постачання, монтаж, випробування, налагодження та введення в експлуатацію згідно контракту на виконання робіт",
        sector: "Електроенергетика",
    ...
    },
    {
        ...
        contract: "Роботи з реконструкції генератора та його системи тиристорного збудження енергоблоку № 5 ДТЕК Бурштинська ТЕС.                      ",
        sector: "Теплоенергетика",
    ...
    },
    {
        ...
        client: "ДП НЕК «Укренерго»",
        contract: " Роботи з розробки робочого проєкту «Реконструкція ВРП 110 кВ ПС 330 кВ «Усатове» для приєднання ПС 110 кВ «Маразліївська»",
        sector: "Електроенергетика",
    ...
    },
    {
        ...
        title: "РЕКОНСТРУКЦІЯ ВРП 110 кВ ПС 330 кВ «УСАТОВЕ»",
        client: "ДП НЕК «Укренерго»",
        contract: "В межах проєкту «Роботи з реконструкції ВРП 110 кВ ПС 330 кВ «Усатове» для приєднання ПС 110 кВ «Маразліївська» було замінено все первинне обладнання, яке використало свій технічний ресурс.",
        sector: "Електроенергетика",
        region: "Українa, Одеська обл.",
        period: "2013",
    },
